...
#
# This may be better done with a Jinja2 template. However the complexity
# of RST is low, making it relatively simple to build a header and footer
# with a list of items in the middle.
